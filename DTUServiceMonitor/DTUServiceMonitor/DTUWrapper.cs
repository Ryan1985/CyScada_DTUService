...
namespace DTUServiceMonitor
{
    ...
    public class DTUWrapper
    {
        [DllImport("DtuLib.dll", CharSet = CharSet.Ansi)]
        ...
        [DllImport("DtuLib.dll", CharSet = CharSet.Ansi)]
        public static extern uint DSGetDtuCount();
        [DllImport("DtuLib.dll", CharSet = CharSet.Ansi)]
        public static extern int DSGetDtuByPosition(uint pos, ref DtuInfoStruct pDtuInfo);
        [DllImport("DtuLib.dll", CharSet = CharSet.Ansi)]
        public static extern void DSGetLastError(string str, int nMaxStrSize);
        [DllImport("DtuLib.dll", CharSet = CharSet.Ansi)]
